<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __("Perbarui username dan informasi profil akun Anda.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="username" name="username" type="text" class="block w-full mt-1" :value="old('username', $user->username)" required autocomplete="username" />
