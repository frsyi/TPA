    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6 mb-8 md:grid-cols-3 lg:grid-cols-4">
                <!-- Jumlah Siswa -->
                <a href="{{ route('siswa.index') }}" class="block">
                    <div class="flex items-center p-6 transition rounded-lg shadow-lg bg-gradient-to-r from-blue-500 to-indigo-600 hover:shadow-xl">
                ...
                <!-- Jumlah Pengajar -->
                <a href="{{ route('pengajar.index') }}" class="block">
                    <div class="flex items-center p-6 transition rounded-lg shadow-lg bg-gradient-to-r from-green-500 to-teal-600 hover:shadow-xl">
                        <div class="p-4 bg-white rounded-full">
